...
if (isset($_POST['name_spelling_first'])) {
    ...
    header('Location: ./join-confirm');
} elseif (!isset($_SESSION['formdata'])) {
    //POSTもSESSIONも無ければjoin-entryに戻る
        ...
        <div class="form">
          <div class="second_width">
            ...
            <div class="form_itm">
              ...
              <div>
                <?php echo $formdata['birth_year']; ?>年
                <?php echo $formdata['birth_month']; ?>月
                <?php echo $formdata['birth_day']; ?>日
              </div>
            </div>
            <div class="form_itm">
              <div class="back_color">
              ...
              <div> <?php echo $formdata['family_living_togather']; ?> </div>
            </div>
            <div class="form_itm">
              <div class="back_color">
                <h2 class="required">同居以外のご家族</h2>
              </div>
              <div> <?php echo $formdata['family_separated']; ?> </div>
            </div>
            <div class="form_itm">
              <div class="back_color">
                <h2>ご質問など</h2>
            ...
            <a href="/join-entry/" class="form_back f_mincho">戻って修正する</a>
            <a href="/join-complete/" class="form_next f_mincho">この内容で送信する</a>
          </div>
        </div>
      </div>
    </section>
