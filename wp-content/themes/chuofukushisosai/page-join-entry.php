...
<body>
  ...
  <main>
    ...
    <section id="form_sct">
      <div class="base_width">
        <p>
          福祉の会への入会は随時受け付けております。<br>
          当方にて確認後、一週間程度で会員証を郵送いたします。
        </p>

        <form method="POST" action="/join-confirmation/" class="form">
          <div class="second_width">
            ...
            <div class="form_itm">
              ...
              <input type="radio" id="option1" name="gender" value="男性">
              <label for="option2">女性</label>
              <input type="radio" id="option2" name="gender" value="女性">
            </div>
            <div class="form_itm">
              <div class="back_color">
            ...
            <div class="form_itm">
              <div class="back_color">
                <h2 class="required">同居のご家族</h2>
              </div>
              <select name="family_living_togather" id="family_living_togather" required>
                <option value=""></option>
            ...
            <div class="form_itm">
              <div class="back_color">
                <h2 class="required">同居以外のご家族</h2>
              </div>
              <select name="family_separated" id="family_separated" required>
                <option value=""></option>
                <option value="1人">1人</option>
                <option value="2人">2人</option>
                <option value="3人">3人</option>
            ...
            <div class="form_itm">
              ...
              <div><textarea name="message" id="message" rows="5"></textarea></div>
            </div>
