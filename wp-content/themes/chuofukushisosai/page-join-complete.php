...
//
//global $wpdb;
//$tablename =  $wpdb->prefix . "fukushinokai_join";
...
//         'family_living_togather'    => $formdata['family_living_togather'],
//         'family_separated'          => $formdata['family_separated'],
...
function getMailCore()
{
    ...
    $mail_body_core .= "\n";
    $mail_body_core .= "【性別】\n";
    $mail_body_core .= $formdata['gender']."\n";
    $mail_body_core .= "\n";
    $mail_body_core .= "【生年月日】\n";
    $mail_body_core .= $formdata['birth_year']."年".$formdata['birth_month']."月".$formdata['birth_day']."日\n";
    $mail_body_core .= "\n";
    $mail_body_core .= "【同居のご家族】\n";
    $mail_body_core .= $formdata['family_living_togather']."\n";
    $mail_body_core .= "\n";
    $mail_body_core .= "【同居以外のご家族】\n";
    $mail_body_core .= $formdata['family_separated']."\n";
    $mail_body_core .= "\n";
    $mail_body_core .= "【ご質問など】\n";
    if ($formdata['message']!="") {
...
<head>
  ...
  <title>福祉の会 ご入会【中央福祉葬祭公式HP】</title>
  ...
  <main>
    <div class="p_title">
      <div class="base_width">
        <h1 class="f_mincho">福祉の会 ご入会</h1>
      </div>
    </div>
    <section id="form_sct">
      <div class="base_width">
        <p>福祉の会のご入会申し込みを受け付けました。</p>
        <div class="form">
          <div class="second_width">
            ...
            <p class="thanks_msg">
              このたびは福祉の会のご入会申し込みをいただきありがとうございます。<br>
              確認のためご入力いただいたメールアドレスに自動送信させていただきました。<br>
              当方にて確認後、一週間程度で会員証を郵送いたします。恐れ入りますがしばらくお待ちください。
            </p>
