  ...
  <div class="header-content-block">
    <div class="header-content__logo">
      <a href="<?php echo home_url(); ?>" class="header-content__link">
        <?php if ($logo_image) : ?>
          <img src="<?php echo esc_url($logo_image[0]); ?>" class="header-content__img" width="180" height="auto" alt="<?php echo $logo_alt; ?>">
        <?php endif; ?>
      </a>
    </div>
    <div class="header-content__info">
      ...
      <div class="header-content__square">
        <a href="<?php echo home_url(); ?>/flow/#anchi" class="title-square-link">
          <span class="square_block block_default">
            安置室<br>完備
          </span>
          <span class="square_block block_hover">
            24時間<br>OK
          </span>
        </a>
      </div>
