...
?>
<div class="component-faq" id="accordion-faq-page">
  <div class="faq-head">
    <h1 class="faq__h">
      家族葬・葬儀でよくあるご質問
    </h1>
          ...
          <ul class="faq-category-list">
            <?php while (have_rows('faq_cate', $page_id)): the_row(); ?>
              <li class="faq-category-item">
                <a href="#<?php echo urlencode(get_sub_field('faq_title', $page_id)); ?>" class="faq-category-link">
      ...
      <?php if (have_rows('faq_cate', $page_id)): ?>
        <div class="faq-content">
          <?php while (have_rows('faq_cate', $page_id)) : the_row(); ?>
            ...
            ?>
            <div class="faq-content-item <?php echo $active; ?>" id="<?php echo urlencode(get_sub_field('faq_title', $page_id)); ?>">
