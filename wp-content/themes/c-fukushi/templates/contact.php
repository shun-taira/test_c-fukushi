    ...
    <div class="display-block">
      <div class="display-wrap">
        <div class="display-head">
          ...
          <h2 class="display__h">
            中央福祉葬祭<span class="inline_pc">　</span><br class="display_sp">LINE公式アカウント
          </h2>
        </div>
        ...
        <div class="method-body">
          <div class="method-content">
            ...
            <div class="method__link">
              <a href="https://lin.ee/6m53CrY" class="link_line-btn" target="_blank">
    ...
    <div class="flow-body">
        ...
        <div class="flow-inner">
          <div class="flow-start">
            <div class="flow-img-wrap">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/line-step1.png" class="flow__img">
            </div>
          </div>
          <div class="flow-end">
      ...
      <div class="flow-content">
        <div class="flow-inner">
          <div class="flow-start">
            <div class="flow-img-wrap">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/line-step2.png" class="flow__img">
            </div>
          </div>
          <div class="flow-end">
            <h3 class="flow__h-sub">
            ...
            <p class="flow__p">
              トーク画面で中央福祉葬祭のスタッフに質問や相談などしていただけます。<br>
              お気軽にご入力ください。
            </p>
          </div>
        </div>
      ...
      <div class="flow-content">
        <div class="flow-inner">
          <div class="flow-start">
            <div class="flow-img-wrap">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/line-step3.png" class="flow__img">
            </div>
          </div>
          <div class="flow-end">
            <h3 class="flow__h-sub">
