...
<section>
  <div class="hall-item-anchi" id="anchi">
    <div class="anchi-block">
      <div class="anchi-head">
        <h2 class="anchi__h">
          ご安置
        </h2>
      </div>
      <div class="anchi-body">
        <div class="anchi-wrap">
          <div class="anchi-start">
            <div class="anchi-img-wrap">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/Photo-028-1024x683.jpg" class="anchi__img">
            </div>
          </div>
          <div class="anchi-end">
            <p class="anchi__p">
              中央福祉葬祭では、24時間365日受け入れ可能な安置室を完備しております。<br class="display_pc">ご自宅でのご安置が難しい場合も、大切な故人様を責任もってお預かりいたしますので、どうぞ安心してご利用ください。
            </p>
          </div>
        </div>
      </div>
